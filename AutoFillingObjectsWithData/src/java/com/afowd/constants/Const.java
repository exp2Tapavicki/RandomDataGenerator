...
public class Const {
    ...
    public static final String COMMA_DELIMITER_ESCAPED = "\\,";
    ...
    public static final String CLASS_PACKAGE = "com.afowd.ormClasses";
    public static final String ENUM_PACKAGE = "com.afowd.enumeration";
