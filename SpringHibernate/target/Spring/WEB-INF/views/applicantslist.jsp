			...
			<table class="table table-hover">
				...
				<c:forEach items="${applicants}" var="applicant">
					<tr>
						...
						<td><a href="<c:url value='/edit-applicant-${applicant.id}' />" class="btn btn-success custom-width">edit</a></td>
						<td><a href="<c:url value='/delete-applicant-${applicant.id}' />" class="btn btn-danger custom-width">delete</a></td>
					</tr>
				</c:forEach>
	    		</tbody>
	    	</table>
