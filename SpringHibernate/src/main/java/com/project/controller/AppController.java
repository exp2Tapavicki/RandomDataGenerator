...
public class AppController {
    ...
    public String login(ModelMap model, Authentication authentication) {
        ...
        return redirectDependingOnRoles(authentication);
    }
    ...
    public String loginPage() {
        return redirectDependingOnRoles();
    }
    ...
    private String redirectDependingOnRoles() {
        return redirectDependingOnRoles(null);
    }

    @SuppressWarnings("unchecked")
    private String redirectDependingOnRoles(Authentication authentication) {
        Collection<GrantedAuthority> roles;
        if (authentication == null) {
            authentication = SecurityContextHolder.getContext().getAuthentication();
        }
        roles = (Collection<GrantedAuthority>) authentication.getAuthorities();
