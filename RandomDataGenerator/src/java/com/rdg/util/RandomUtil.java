...
public class RandomUtil {
    ...
    public static final List<String> listOfHashTypes = Arrays.asList(Map.class.getName(), HashMap.class.getName(), Set.class.getName(), HashSet.class.getName(), TreeMap.class.getName(), Hashtable.class.getName());
    ...
    public static String getRandomNames(int name, boolean bAllowNulls) {
        ...
        } else if (name == Const.EMAIL) {
            return String.valueOf(sFirstName.toLowerCase() + "." + sLastName.toLowerCase() + Const.STRING_EMAIL_AT);
        } else {
            return null;
        }
    }
    ...
    public static Object getRandomEnum(int objMin, int objMax, String[] objEnum, Class cl) {
        ...
        if (objEnum != null && cl != null) {
            ...
            enumeration = objEnum[RandomUtil.getRandomPrimitiveInt(objMin, objMax)].trim();
        }
        return enumeration;
    }
}
